...
function mergeTemplateCollections(templateCollections) {
	var mergedCollection = {};
	templateCollections.forEach(function(templateCollection) {
		if (templateCollection) {
			Object.keys(templateCollection).forEach(function(templateName) {
				var templateObject = templateCollection[templateName];
