	...
	js : [
		{
			...
			src : [
				...
				path.join(reportAssetsPath, "js/lib/jquery.highlight.js"),
				path.join(reportAssetsPath, "js/jquery.stateManager-1.0.0.js"),
				path.join(reportAssetsPath, "js/jquery.elementManager-1.0.0.js"),
				path.join(reportAssetsPath, "js/jquery.dragbar-1.0.0.js"),
				path.join(reportAssetsPath, "js/cukeTree.js"),
				path.join(reportAssetsPath, "js/cukeTree.report.js"),
