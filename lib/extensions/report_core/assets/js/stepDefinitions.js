	...
	$.fn.stepDefinitions = function() {	
		...
		function setupStepsReport() {
			...
			$stepDefs.find(".open-stepdefs").click(function(e) {
				$cukeTree.cukeTreeIde().openFile($(this).data("path"));
			});
